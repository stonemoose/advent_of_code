            ...
            for z in range(1, size-1):
                ...
                for w in range(1, size-1):
                    ...
                    if hyper_cubes[x][y][z][w] == '.' and n == 3:
                        ...
                        hyper_cubes[x][y][z][w] = '.'
print('Part 1: ', sum(char == '#' for plane in cubes for line in plane for char in line))
print('Part 2: ', sum(char == '#' for cube in hyper_cubes for plane in cube for line in plane for char in line))
